...
<textarea name=specification onfocus="v_open(this,2000);" onkeydown="return (len(this,null)?true:false);" onblur=<?php echo ($row?'editfield_2("services/sell/products/update_product.php","'.$row['id'].'","specification","\""+this.value+"\"",specification_v(this));':'specification_v(this);'); ?> ><?php echo ($row?$row['specification']:''); ?></textarea>
<script> var options = [
<?php 
