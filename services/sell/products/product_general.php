...
<span><input name=bulk type=checkbox <?php echo ($row?'onchange=editfield("services/sell/products/update_product.php","'.$row['id'].'","bulk",'.($row['bulk']?'0':'1').');':''); ?>  <?php echo ($row['bulk']?'checked':''); ?> />Bulk(<?php echo $row['bulk']; ?>)</span>
